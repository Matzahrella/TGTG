...
# Load credentials from the fluffy credentials file
with open("fluffy_credentials.json", "r") as f:
...
# The item_id for Rosa Pizza (Mixed Bag)
item_id = "1029002"
...
# Attempt to reserve 2 bags
try:
    # Call create_order with the correct arguments
    response = client.create_order(item_id=item_id, item_count=2)  # Reserve 2 bags
    print("✅ Successfully reserved the bags!")
    ...
    print("❌ Failed to reserve the bags:", str(e))