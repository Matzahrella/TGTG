...
# Load credentials from Joshua's credentials file
with open("joshua_credentials.json", "r") as f:
    credentials = json.load(f)

# Debug: Print loaded credentials
print("Loaded credentials for Joshua:", credentials)
...
try:
    ...
    if order_id:
        file_path = "joshua_last_order_id.json"
